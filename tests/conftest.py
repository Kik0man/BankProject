...
def transactions_without_currency_info() -> list[dict[str, Any]]:
    ...
    return [
        {"id": 1, "description": "Транзакция без operationAmount", "from": "Счет 123", "to": "Счет 456"},
        {
            "id": 2,
        ...
        {
            "id": 3,
            "operationAmount": {"amount": "200.00", "currency": {"name": "USD"}},  # Без code
...
def description_test_transactions() -> list[dict[str, Any]]:
    ...
    return [
        ...
        {"id": 4, "operationAmount": {"amount": "100.00", "currency": {"code": "USD"}}},  # Без описания
    ]
